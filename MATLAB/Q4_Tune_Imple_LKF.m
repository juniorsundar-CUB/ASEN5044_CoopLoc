...
subplot(3,2,1)
plot(t,wrapToPi(y_truth(1,:)),'LineWidth',1.5)
hold on
plot(t,wrapToPi(y_est(1,:)),'r--','LineWidth',1.5)
hold off
...
subplot(3,2,2)
plot(t,y_truth(2,:),'LineWidth',1.5)
hold on
plot(t,y_est(2,:),'r--','LineWidth',1.5)
hold off
...
subplot(3,2,3)
plot(t,wrapToPi(y_truth(3,:)),'LineWidth',1.5)
hold on
plot(t,wrapToPi(y_est(3,:)),'r--','LineWidth',1.5)
hold off
...
subplot(3,2,4)
plot(t,y_truth(4,:),'LineWidth',1.5)
hold on
plot(t,y_est(4,:),'r--','LineWidth',1.5)
hold off
title('$\xi_a$ vs. $t$','FontSize',16,'Interpreter','latex')
ylabel('$\xi_a$ (m)','FontSize',14,'Interpreter','latex')
xlabel('Time | $t$ (s)','FontSize',14,'Interpreter','latex')
...
subplot(3,2,[5,6])
plot(t,y_truth(5,:),'LineWidth',1.5)
hold on
plot(t,y_est(5,:),'r--','LineWidth',1.5)
hold off
title('$\eta_a$ vs. $t$','FontSize',16,'Interpreter','latex')
ylabel('$\eta_a$ (m)','FontSize',14,'Interpreter','latex')
xlabel('Time | $t$ (s)','FontSize',14,'Interpreter','latex')
...
legend({'$y_{truth}$','$y_{estimate}$'},'FontSize',12,'Interpreter','latex')

%__________________________________________________________________________

figure(5)
sgtitle('\bf{Measurement Estimate Errors}','FontSize',18,'Interpreter','latex')
subplot(3,2,1)
plot(t,e_y(1,:),'LineWidth',1.5)
C = zeros(2,length(t));
C(1,:) = 2*(sqrt(S(1,1,:)));
C(2,:) = -2*(sqrt(S(1,1,:)));
hold on
...
plot(t,C(2,:),'r--','LineWidth',1.5)
hold off
title('$e_{\gamma_{ag}}$ vs. $t$','FontSize',16,'Interpreter','latex')
ylabel('$e_{\gamma_{ag}}$ (rad)','FontSize',14,'Interpreter','latex')
xlabel('Time | $t$ (s)','FontSize',14,'Interpreter','latex')
grid on
% axis([min(t) max(t) -20 20])

subplot(3,2,2)
plot(t,e_y(2,:),'LineWidth',1.5)
C(1,:) = 2*(sqrt(S(2,2,:)));
C(2,:) = -2*(sqrt(S(2,2,:)));
hold on
plot(t,C(1,:),'r--','LineWidth',1.5)
plot(t,C(2,:),'r--','LineWidth',1.5)
hold off
title('$e_{\rho_{ga}}$ vs. $t$','FontSize',16,'Interpreter','latex')
ylabel('$e_{\rho_{ga}}$ (m)','FontSize',14,'Interpreter','latex')
xlabel('Time | $t$ (s)','FontSize',14,'Interpreter','latex')
grid on
% axis([min(t) max(t) -20 20])

subplot(3,2,3)
plot(t,e_y(3,:),'LineWidth',1.5)
C(1,:) = 2*(sqrt(S(3,3,:)));
C(2,:) = -2*(sqrt(S(3,3,:)));
hold on
plot(t,C(1,:),'r--','LineWidth',1.5)
plot(t,C(2,:),'r--','LineWidth',1.5)
hold off
title('$e_{\gamma_{ga}}$ vs. $t$','FontSize',16,'Interpreter','latex')
ylabel('$e_{\gamma_{ga}}$ (rad)','FontSize',14,'Interpreter','latex')
xlabel('Time | $t$ (s)','FontSize',14,'Interpreter','latex')
grid on
% axis([min(t) max(t) -1 1])

subplot(3,2,4)
plot(t,e_y(4,:),'LineWidth',1.5)
C(1,:) = 2*(sqrt(S(4,4,:)));
C(2,:) = -2*(sqrt(S(4,4,:)));
hold on
plot(t,C(1,:),'r--','LineWidth',1.5)
...
grid on
% axis([min(t) max(t) -10 10])
legend({'$e_{y}$','$\pm2\sigma$'},'FontSize',12,'Interpreter','latex')