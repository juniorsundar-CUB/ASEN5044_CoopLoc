...
figure(1)
sgtitle('\bf{States Dynamics w/ DT Linear Model}','FontSize',18,'Interpreter','latex')
subplot(3,2,1)
...
figure(2)
sgtitle('\bf{Measurements Dynamics w/ DT Linear Model}','FontSize',18,'Interpreter','latex')
subplot(3,2,1)
